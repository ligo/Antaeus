package com.oceanai.quartz.job;
...
public class IndexMonitorJob implements Job {
    private Logger logger = LoggerFactory.getLogger(IndexMonitorJob.class);
    //private int intervals = 3;
    private String fieldName = OceanFeature.FIELD_NAME_OCENAI_FEATURE;
    public IndexMonitorJob() {

    }

    @Override
    public void execute(JobExecutionContext context) throws JobExecutionException {
        int intervals = (int)context.getJobDetail().getJobDataMap().get("intervals");
