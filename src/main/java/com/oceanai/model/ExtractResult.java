...
/**
 * Returned values of calling API service.
...
public class ExtractResult {
    ...
    public ExtractResult(String error_message, int face_nums, int dimension, String request_id, int time_used, FaceFeature[] result) {
