...
//                featureCache.put(counter, new SearchItem(cachedInstance.getByteArrayRepresentation(), new SimpleResult(-1d, counter, d.getValues(OceanDocumentBuilder.FIELD_NAME_IDENTIFIER)[0])));
