...
public class Extractor implements Runnable {
    public static final String[] features = new String[]{
            "net.semanticmetadata.test.imageanalysis.features.global.CEDD",                  // 0
            "net.semanticmetadata.test.imageanalysis.features.global.FCTH",                  // 1
            "net.semanticmetadata.test.imageanalysis.features.global.OpponentHistogram",     // 2
            "net.semanticmetadata.test.imageanalysis.features.global.JointHistogram",        // 3
            "net.semanticmetadata.test.imageanalysis.features.global.AutoColorCorrelogram",  // 4
            "net.semanticmetadata.test.imageanalysis.features.global.ColorLayout",           // 5
            "net.semanticmetadata.test.imageanalysis.features.global.EdgeHistogram",         // 6
            "net.semanticmetadata.test.imageanalysis.features.global.Gabor",                 // 7
            "net.semanticmetadata.test.imageanalysis.features.global.JCD",                   // 8
            "net.semanticmetadata.test.imageanalysis.features.global.JpegCoefficientHistogram", //9
            "net.semanticmetadata.test.imageanalysis.features.global.ScalableColor",         // 10
            "net.semanticmetadata.test.imageanalysis.features.global.SimpleColorHistogram",  // 11
            "net.semanticmetadata.test.imageanalysis.features.global.Tamura",                // 12
            "net.semanticmetadata.test.imageanalysis.features.global.LuminanceLayout",       // 13
            "net.semanticmetadata.test.imageanalysis.features.global.PHOG",                  // 14
            "net.semanticmetadata.test.imageanalysis.features.global.LocalBinaryPatterns",   // 15
    };
